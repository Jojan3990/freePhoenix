<?php
require_once './Database/upload/connect.php';
?>
<main>
                    ...
                    if($query){
                        if(mysqli_num_rows($query)<=0){
                            ...
                            while($row=mysqli_fetch_assoc($query)){
                                ...
                                $name_person=$row['user_name'];

                                $pic=$row['user_pic_show'];
                                $profile_pic_path='assets/profile/'.$pic;

                                $link_reach=$row['user_link'];
                                ?>
                                    <div class="image">
                                        <a href=<?php if(isset($link_reach) && !empty($link_reach)) 
                                                                { 
                                                                    echo $link_reach ;
                                                                } 
                                                                    ...
                                                                    { 
                                                                        echo "#" ;
                                                                    } ; ?> target="_blank"><h1> <div class="picAll"><img src=<?php echo $profile_pic_path ; ?> alt="profile_pic"></div> <div class="follow">Reach Them Here</div> <div class="name"><?php echo $name_person ; ?></div> </h1></a> 
